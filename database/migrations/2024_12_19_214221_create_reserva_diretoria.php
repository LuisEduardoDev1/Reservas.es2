...
return new class extends Migration
{
    ...
    {
        Schema::create('reserva_diretoria', function (Blueprint $table) {
            $table->id('id_reserva_diretor'); // Cria uma coluna auto-incremento
    ...
    {
        Schema::dropIfExists('reserva_diretoria');
    }
};
